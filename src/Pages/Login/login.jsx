            ...
            <div className="main-div flex flex-col justify-center items-center text-center w-[55vh] bg-[#1a3a25] ">
                ...
                <main className="contenido">
                    ...
                    <div className="formularios">
                            ...
                            <div className="form-login" id="form-login">
                                <form className="f-login">
                                    ...
                                    <div className="div-cuenta">
                                        ...
                                        <a href="#" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setIsLoginView(false); }}>Regístrate</a>
                                    </div>   
                            </div>
                        )}
                        ...
                        {/* --- FORMULARIO REGISTRO --- */}
                        {!isLoginView && (
                            <div className="form-registro" id="form-registro">
                                ...
                                <div className="div-olvidaste m-3">
                                    <div className="div-cuenta-form">
                                        <p>¿Ya tienes una cuenta?</p>
                                        {/* Enlace para cambiar a Login */}
                                        {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
                                        <a href="#" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setIsLoginView(true); }}>Inicia Sesión</a>
                                    </div>
                                    <BotonEnviarRegistro nombre={nombre} email={email} password={contraseña} setContraseña={setContraseña} setEmail={setEmail} setNombre={setNombre} />
                                </div>
